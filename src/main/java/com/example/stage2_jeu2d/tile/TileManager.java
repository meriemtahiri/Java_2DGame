package com.example.stage2_jeu2d.tile;

import com.example.stage2_jeu2d.GamePanel;
import com.example.stage2_jeu2d.UtilityTool;
...
public class TileManager {
    ...
    public void setup(int index, String imageName, boolean collision) {
        ...
        try {
            ...
            tiles[index].image = new Image(getClass().getResourceAsStream("/tiles/" + imageName + ".png"));
    ...
    public void draw(GraphicsContext g) {
        ...
        while (worldCol < gamePanel.maxWorldCol && worldRow < gamePanel.maxWorldRow) {
            ...
            if (worldX + gamePanel.tileSize > gamePanel.player.worldX - gamePanel.player.screenX &&
                    ...
                    worldY - gamePanel.tileSize < gamePanel.player.worldY + gamePanel.player.screenY) {
                g.drawImage(tiles[tileNum].image, screenX, screenY);
            }
